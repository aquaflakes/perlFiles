...
my $usage = "\n\$$this_programme -f '*.txt' -o kmer_cnt -k 6 --m --u (--ori --uOut)
  ...
  ## specific ## 
   ...
   ";
	##### options
	GetOptions ('f=s' => \my $fileGlob,'o=s' => \my $outputPath, 'h' => \my $helpInfo,'u' => \my $rmdup, 'k=i' => \my $k_length, 'w=i' => \my $win_size,'m' => \my $multiCntperSeq,
